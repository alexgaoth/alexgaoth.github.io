...
const SHIPS = [
  {
    ...
    img: '/resources/signalor.png', anchor: 'signalor',
  },
  { year: '2025', name: 'ucsd_crimes',      tech: 'react · py · selenium',  status: 'live',       img: '/resources/ucsd_crimes.png',       anchor: 'ucsd-crimes-log-tracker' },
  { year: '2025', name: 'dont-hallucinate', tech: 'py · powershell · bash', status: 'pypi',       img: '/resources/dont_hallucinate.png',  anchor: 'dont-hallucinate' },
  { year: '2024', name: '3d julia set sim', tech: 'unity · c# · math',      status: 'live',       img: '/resources/julia_set.png',         anchor: '3d-fractal-simulator' },
  { year: '2024', name: 'radians.co.uk',    tech: 'react · node · mongo',   status: 'shipped',    img: '/resources/default.jpg' },
  { year: '2024', name: 'speech classifier',tech: 'py · linear algebra',    status: '98.9% acc',  img: '/resources/political_speech.png',  anchor: 'political-speech-classifier' },
  { year: '2023', name: 'pixel platformer', tech: 'godot · gdscript',       status: 'playable',   img: '/resources/godot_game.png',        anchor: '2d-pixel-plateformer' },
  { year: '2022', name: 'alexgaoth.com v0', tech: 'html · css · js',        status: 'live',       img: '/resources/this_website.png',      anchor: 'this-very-website' },
];
...
function BuildLogRow({ ship, onHover }) {
  ...
  return (
    <Link
      ...
      onMouseEnter={() => { setHover(true);  if (onHover) onHover(ship); }}
      onMouseLeave={() => { setHover(false); if (onHover) onHover(null); }}
    >
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {(isMobile ? SHIPS : rest).map((s) => (
              <BuildLogRow key={s.name} ship={s} onHover={!isMobile ? setHoveredShip : undefined} />
            ))}
          </div>
        </div>
      </div>
